...
def test_ch4_nominal_and_rollout(sys_disturbance):
    a4, a5 = load("algorithm_4_4"), load("algorithm_4_5")
...
def test_ch4_fixed_rollout_and_pdf(sys_disturbance, traj_distribution):
    a6, a8, a2 = load("algorithm_4_6"), load("algorithm_4_8"), load("algorithm_4_2")
...
def test_ch4_likelihood_objectives(sys_disturbance):
    ...
    a9 = load("algorithm_4_9"); a9.extract = ex
    a10 = load("algorithm_4_10"); a10.extract = ex
